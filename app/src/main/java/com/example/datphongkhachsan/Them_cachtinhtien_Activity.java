...
public class Them_cachtinhtien_Activity extends AppCompatActivity {
    Button butThem_Cachtinh, butCannel_Cachtinh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_them_cachtinhtien );
        anhxa();
    ...
    private void anhxa(){
        butThem_Cachtinh   = (Button) findViewById( R.id.btnThem_Cachtinhtien );
        ...
        butThem_Cachtinh.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                Intent mhCachTinh = new Intent(Them_cachtinhtien_Activity.this, CachTinhTien_Activity.class);
...
//                Toast.makeText(Them_cachtinhtien_Activity.this, product.name_loaiPhong_cachTinhTien,Toast.LENGTH_LONG).show();
//            }
//        } );
        ...
        butCannel_Cachtinh.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mhCannal = new Intent(Them_cachtinhtien_Activity.this, CachTinhTien_Activity.class);
