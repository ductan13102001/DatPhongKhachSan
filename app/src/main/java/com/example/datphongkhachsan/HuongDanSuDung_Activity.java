...
public class HuongDanSuDung_Activity extends AppCompatActivity {
    Toolbar home_Toolab;
    ...
    private void actionMenu() {
        ...
        home_listView.setOnItemClickListener( new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 0:
                        Intent sceenHome = new Intent(HuongDanSuDung_Activity.this, TrangChinh_Activity.class);
                        startActivity( sceenHome );
                        break;
                    case 1:
                        sceenHome = new Intent(HuongDanSuDung_Activity.this, Thue_TraPhong_Activity.class);
                        startActivity( sceenHome );
                        break;
                    case 2:
                        sceenHome = new Intent(HuongDanSuDung_Activity.this, DatPhong_Activity.class);
                        startActivity( sceenHome );
                        break;
                    case 3:
                        sceenHome = new Intent(HuongDanSuDung_Activity.this, QuanLyKho_Activity.class);
                        startActivity( sceenHome );
                        break;
                    case 4:
                        sceenHome = new Intent(HuongDanSuDung_Activity.this, QuanLy_ThuChi_Activity.class);
                        startActivity( sceenHome );
                        break;
                    case 5:
                        sceenHome = new Intent(HuongDanSuDung_Activity.this, QuanLy_HeThong_Activity.class);
                        startActivity( sceenHome );
                        break;
                    case 6:
                        sceenHome = new Intent(HuongDanSuDung_Activity.this, TaiKhoan_Activity.class);
                        startActivity( sceenHome );
                        break;
                    case 7:
                        sceenHome = new Intent(HuongDanSuDung_Activity.this, HuongDanSuDung_Activity.class);
                        startActivity( sceenHome );
                        break;
                    case 8:
